    """
    Health Checker K3rknobs
    =======================
    Minimal HTTP service that acts as a relay layer for existing third-party APIs.
    ...
    APP_NAME    = "Health Checker K3rknobs"
    APP_VERSION = "1.0.0"
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Minimal HTTP service that acts as a relay layer for existing third-party APIs.")
